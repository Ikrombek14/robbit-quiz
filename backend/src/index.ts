...
import { extraLessonsRouter } from "./routes/extraLessons.js";
import { practiceRouter } from "./routes/practice.js";
import { newCurriculumRouter } from "./routes/newCurriculum.js";
...
app.use("/api/extra-lessons", extraLessonsRouter);
app.use("/api/practice", practiceRouter);
app.use("/api/new-curriculum", newCurriculumRouter);
